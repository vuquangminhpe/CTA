  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full text-center'>
        ...
        <h2 className='text-3xl font-bold text-gray-900 mb-4'>Trang này không tồn tại</h2>
        <p className='text-lg text-gray-700 mb-8'>Trang bạn đang tìm kiếm không tồn tại hoặc đã bị di chuyển.</p>
