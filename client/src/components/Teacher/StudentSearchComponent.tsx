...
const StudentSearchComponent: React.FC = () => {
  ...
  const handleTextSearch = async () => {
    ...
    try {
      const response = await fetch('https://thicuonlinne-production.up.railway.app//api/search/students/text', {
        method: 'POST',
        headers: {
  ...
  const handleImageSearch = async () => {
    ...
    try {
      ...
      const response = await fetch('https://thicuonlinne-production.up.railway.app//api/search/students/image', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('access_token')}`
        },
