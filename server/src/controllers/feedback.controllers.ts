...
export const getFeedbackByIdController = async (
  req: Request<{ feedback_id: string }>,
  res: Response
) => {
  try {
...
export const resolveFeedbackController = async (
  req: Request<{ feedback_id: string }>,
  res: Response
) => {
  try {
...
export const closeFeedbackController = async (
  req: Request<{ feedback_id: string }>,
  res: Response
) => {
  try {
...
export const getTopTagsController = async (
  req: Request,
  res: Response
) => {
  try {
...
export const getRecentFeedbacksController = async (
  req: Request,
  res: Response
) => {
  try {
